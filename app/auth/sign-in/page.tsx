      ...
      <div className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-12">
            <h1 className="text-h2 text-foreground mb-3">Welcome Back</h1>
            <p className="text-base text-foreground/70">Sign in to your account to continue learning</p>
          </div>
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-background text-foreground/60">Or continue with email</span>
            </div>
          </div>
          ...
          <p className="text-center text-foreground/70 mb-12">
            ...
            <Link href="/auth/sign-up" className="text-accent hover:text-accent/90 font-semibold">
              Sign up
            </Link>
          </p>
